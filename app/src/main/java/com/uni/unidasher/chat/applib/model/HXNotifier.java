 ...
 */
package com.uni.unidasher.chat.applib.model;
...
//                }
//            }
            String summaryBody = notifyText;
            mBuilder.setContentTitle(contentTitle);
            mBuilder.setTicker(notifyText);
            mBuilder.setContentText(username+" "+summaryBody);
...
//                notificationManager.cancel(foregroundNotifyID);
                DataProvider.getInstance(appContext).getEventBus().post(new CustomerNotificationEvent("来自:"+username+"消息\n"+summaryBody));
            } else {
