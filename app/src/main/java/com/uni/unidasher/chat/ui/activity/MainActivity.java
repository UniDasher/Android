...
//
//		fragments = new Fragment[] { chatHistoryFragment, null, settingFragment };
//		// 添加显示第一个fragment
...
//		if (DasherApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
//			unreadAddressCountTotal = DasherApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
